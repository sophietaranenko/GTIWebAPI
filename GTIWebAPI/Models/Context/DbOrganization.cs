...
namespace GTIWebAPI.Models.Context
{
    ...
    /// </summary>
    //public class DbMain : DbContext, IDbContextOrganization
    //{
    ...
    //    public DbMain(string userName) : base(CreateConnectionString(userName))
    //    {
    //        this.Configuration.LazyLoadingEnabled = false;
    //    }

    //    //Construct connection string with username 
    //    public static string CreateConnectionString(string userName)
    //    {
